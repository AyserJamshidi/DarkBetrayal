...
public class cmd_ely extends ChatCommand {
    ...
    public void runImpl(@NotNull Player player, @NotNull String command, @NotNull String... params) {
        ...
        if (params == null || params.length < 1) {
            player.sendMsg("Синтаксис команды .ely Сообщение");
            return;
        }
        ...
        if (player.getRace() != Race.ELYOS && player.getAccessLevel() < 1) {
            player.sendMsg("You can't talk with another race.");
            return;
        }
