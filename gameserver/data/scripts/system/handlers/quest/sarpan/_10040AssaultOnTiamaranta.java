        ...
        if (qs.getStatus() == QuestStatus.START) {
            if (targetId == 798926 && var == 0) {
                ...
                if (env.getDialog() == QuestDialog.START_DIALOG) {
                    ...
                    TeleportService.teleportTo(player, 300410000, newInstance.getInstanceId(), 772f, 211f, 1029f);
                ...
                if (env.getDialog() == QuestDialog.USE_OBJECT) {
                    TeleportService.teleportTo(player, 300410000, player.getInstanceId(), 756, 214, 1029, (byte) 116, TeleportAnimation.BEAM_ANIMATION);
                    return true;
                } else {
                    return sendQuestStartDialog(env);
                }
                ...
                if (env.getDialog() == QuestDialog.USE_OBJECT) {
                    ...
                    updateQuestStatus(env);
                    TeleportService.teleportTo(player, 600020000, 1, 1219, 1361, 1359, (byte) 70, TeleportAnimation.BEAM_ANIMATION);
                    return closeDialogWindow(env);
                } else {
                    return sendQuestStartDialog(env);
                }
