...
public class _28643KaligasCollection extends QuestHandler {

    private final static int questId = 28643;

    public _28643KaligasCollection() {
        super(questId);
    }

    @Override
    public void register() {
        qe.registerQuestNpc(730775).addOnQuestStart(questId);
        qe.registerQuestNpc(730775).addOnTalkEvent(questId);
    }
    ...
    public boolean onDialogEvent(QuestEnv env) {
        ...
        if (targetId == 730775 && player.getRace() == Race.ASMODIANS) {
            if (qs == null || qs.getStatus() == QuestStatus.NONE || qs.canRepeat()) {
