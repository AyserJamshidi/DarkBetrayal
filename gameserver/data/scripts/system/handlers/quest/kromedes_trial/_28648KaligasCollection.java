...
public class _28648KaligasCollection extends QuestHandler {

    private final static int questId = 28648;

    public _28648KaligasCollection() {
        super(questId);
    }

    @Override
    public void register() {
        qe.registerQuestNpc(730887).addOnQuestStart(questId);
        qe.registerQuestNpc(730887).addOnTalkEvent(questId);
    }
    ...
    public boolean onDialogEvent(QuestEnv env) {
        ...
        if (targetId == 730887 && player.getRace() == Race.ASMODIANS) {
            if (qs == null || qs.getStatus() == QuestStatus.NONE || qs.canRepeat()) {
