...
public class _28645KaligasCollection extends QuestHandler {

    private final static int questId = 28645;

    public _28645KaligasCollection() {
        super(questId);
    }

    @Override
    public void register() {
        qe.registerQuestNpc(730777).addOnQuestStart(questId);
        qe.registerQuestNpc(730777).addOnTalkEvent(questId);
    }
    ...
    public boolean onDialogEvent(QuestEnv env) {
        ...
        if (targetId == 730777 && player.getRace() == Race.ASMODIANS) {
            if (qs == null || qs.getStatus() == QuestStatus.NONE || qs.canRepeat()) {
