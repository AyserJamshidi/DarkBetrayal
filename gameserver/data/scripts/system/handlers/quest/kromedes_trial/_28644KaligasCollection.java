...
public class _28644KaligasCollection extends QuestHandler {

    private final static int questId = 28644;

    public _28644KaligasCollection() {
        super(questId);
    }

    @Override
    public void register() {
        qe.registerQuestNpc(730776).addOnQuestStart(questId);
        qe.registerQuestNpc(730776).addOnTalkEvent(questId);
    }
    ...
    public boolean onDialogEvent(QuestEnv env) {
        ...
        if (targetId == 730776 && player.getRace() == Race.ASMODIANS) {
            if (qs == null || qs.getStatus() == QuestStatus.NONE || qs.canRepeat()) {
