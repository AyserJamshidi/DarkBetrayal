            ...
            switch (targetId) {
                case 204301: { // Aegir
                    switch (env.getDialog()) {
                        ...
                        case STEP_TO_1:
                            TeleportService.teleportTo(player, 220020000, 2792.74f, 480.63f, 268.01f, (byte) 72, TeleportAnimation.BEAM_ANIMATION);
                ...
                case 204403: { // Taisan
                    switch (env.getDialog()) {
                        ...
                        case STEP_TO_2:
                            TeleportService.teleportTo(player, 220020000 ,3029.74f, 874.63f, 363.01f, (byte) 72, TeleportAnimation.BEAM_ANIMATION);
                ...
                case 204432: { // Kargate
                    switch (env.getDialog()) {
                        ...
                        case STEP_TO_4:
                            if (var == 4) {
                                TeleportService.teleportTo(player, 220020000, 3030.8676f, 875.6538f, 363.2065f);
