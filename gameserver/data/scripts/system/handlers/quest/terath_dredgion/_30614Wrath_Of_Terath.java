 ...
 * Date: 24.04.13
 */
public class _30614Wrath_Of_Terath extends QuestHandler {

    private final static int questId = 30614;

    public _30614Wrath_Of_Terath() {
        super(questId);
    }

    @Override
    public void register() {
        qe.registerQuestNpc(800327).addOnQuestStart(questId);
