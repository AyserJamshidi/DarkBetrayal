...
public class _20023KumbandasWhereabouts extends QuestHandler {
    ...
    private final static int[] npc_ids = {799226, 799292, 700810, 204057, 730243, 799513, 799514, 799515, 799516, 799341, 700706};
            ...
            switch (env.getDialog()) {
                case USE_OBJECT:
                    if (var == 10) {
                        qs.setQuestVar(11);
                        updateQuestStatus(env);
                        TeleportService.teleportTo(player, 220070000, player.getInstanceId(), 2274.8582f, 1602.2708f, 412.31882f, (byte) 90);
                    }
            }
        }
        return false;
