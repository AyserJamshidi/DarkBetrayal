...
public class _2022CrushingtheConspiracy extends QuestHandler {
            ...
            switch (targetId) {
                case 203557: { // Suthran
                    if (env.getDialog() == QuestDialog.START_DIALOG && var == 0) {
                        ...
                        TeleportService.teleportTo(player, 220030000, 2453.1934f, 2555.148f, 316.267f);
    ...
    public boolean onMovieEndEvent(QuestEnv env, int movieId) {
        if (movieId == 154) {
            ...
            TeleportService.teleportTo(env.getPlayer(), 220030000, 2453.1934f, 2555.148f, 316.267f);
            return true;
        }
        return false;
    }
