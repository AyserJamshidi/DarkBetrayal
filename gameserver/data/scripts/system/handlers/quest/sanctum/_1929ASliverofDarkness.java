                    ...
                    switch (dialog) {
                        ...
                        case STEP_TO_3: {
                            if (var == 2) {
                                ...
                                TeleportService.teleportTo(player, 310070000, newInstance.getInstanceId(), 338f, 101f, 1191f);
                    ...
                    switch (dialog) {
                        ...
                        case STEP_TO_4: {
                            if (var == 93) {
                                ...
                                player.sendPck(new SM_EMOTION(player, EmotionType.START_FLYTELEPORT, 31001, 0));
                                return true;
                            }
                        }
                    }
