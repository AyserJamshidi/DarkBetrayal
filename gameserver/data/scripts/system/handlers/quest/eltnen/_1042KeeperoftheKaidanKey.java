...
public class _1042KeeperoftheKaidanKey extends QuestHandler {
    ...
    public void register() {
        ...
        qe.addHandlerSideQuestDrop(questId, 212025, 182201026, 1, 100, true);
        qe.addHandlerSideQuestDrop(questId, 212029, 182201026, 1, 100, true);
        qe.addHandlerSideQuestDrop(questId, 212033, 182201026, 1, 100, true);
