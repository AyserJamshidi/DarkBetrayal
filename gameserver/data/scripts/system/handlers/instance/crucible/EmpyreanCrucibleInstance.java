...
import com.ne.gs.network.aion.serverpackets.SM_INSTANCE_STAGE_INFO;
...
public class EmpyreanCrucibleInstance extends CrucibleInstance {
    ...
    private final List<EmpyreanStage> emperyanStage = new ArrayList<>();
    private byte stage;
	private int r10s1 = 0;
    ...
    public void onEnterInstance(Player player) {
        ...
        if (isNew && stage > 0) {
            ...
            player.sendPck(new SM_SYSTEM_MESSAGE(1400963));
        }
        ...
        player.sendPck(new SM_INSTANCE_SCORE(instanceReward));
        player.sendPck(new SM_INSTANCE_STAGE_INFO(2, stageType.getId(), stageType.getType()));
        ...
        instance.doOnAllPlayers(new Visitor<Player>() {
            ...
            public void visit(Player player) {
                if (player.isOnline()) {
                    CruciblePlayerReward playerReward = getPlayerReward(player.getObjectId());
                    if (nameId != 0) {
                        player.sendPck(new SM_SYSTEM_MESSAGE(1400237, DescId.of(nameId * 2 + 1), points));
                    }
    ...
    private void sendEventPacket(final StageType type, int time) {
        stageType = type;
        ThreadPoolManager.getInstance().schedule(new Runnable() {
            ...
            public void run() {
                instance.doOnAllPlayers(new Visitor<Player>() {
                    ...
                    @Override
                    public void visit(Player player) {
                        player.sendPck(new SM_INSTANCE_STAGE_INFO(2, type.getId(), type.getType()));
                    }
        ...
        switch (npc.getNpcId()) {
            ...
            case 217578:
                ...
                if (player != null) {
                    ...
                    sp(npcId, 1794.81f, 779.53925f, 469.35016f, (byte) 40, 6000);
                }
                break;
            case 217579:
            case 217583:
                ...
                if (player != null) {
                    ...
                    sp(npcId, 1775.6254f, 811.43225f, 469.35022f, (byte) 100, 6000);
                }
                break;
            case 217580:
            case 217584:
                ...
                if (player != null) {
                    ...
                    sp(npcId, 1775.716f, 779.630f, 469.564f, (byte) 20, 6000);
                }
                break;
            case 217581:
            case 217585:
			...
			case 217599:
				...
				sp(205343, 1322.311f, 1741.508f, 316.349f, (byte) 65, 3000);
                break;
            case 217600:
			case 217601:
			case 217602:
			...
			case 217606:
                ...
                if (r10s1 == 6) {
					...
					sp(217603, 1756.213f, 1268.0781f, 394.3f, (byte) 112, 3000);
					sp(217604, 1748.4563f, 1276.1516f, 394.3f, (byte) 112, 18000);
					sp(217605, 1745.1488f, 1291.1216f, 394.3f, (byte) 112, 18000);
					sp(217606, 1751.1488f, 1303.1216f, 394.3f, (byte) 112, 18000);
					sp(217604, 1748.4563f, 1276.1516f, 394.3f, (byte) 112, 18000);
					sp(217605, 1745.1488f, 1291.1216f, 394.3f, (byte) 112, 32000);
					sp(217606, 1751.1488f, 1303.1216f, 394.3f, (byte) 112, 32000);
					sp(217601, 1774.4563f, 1302.1516f, 394.3f, (byte) 82, 32000);
					sp(217602, 1765.1488f, 1305.1216f, 394.3f, (byte) 84, 32000);
                }
				if (r10s1 == 18) {
                    sendEventPacket(StageType.START_STAGE_10_ROUND_3, 2000);
					sp(217607, 1758.1488f, 1301.1216f, 394.3f, (byte) 99, 4000);
                }
                break;
			case 217607:
				despawnNpc(npc);
                sendEventPacket(StageType.START_STAGE_10_ROUND_4, 2000);
				sp(217608, 1778.311f, 1301.508f, 394.349f, (byte) 65, 4000);
                break;
			case 217608:
				despawnNpc(npc);
                sendEventPacket(StageType.START_STAGE_10_ROUND_5, 2000);
				sp(217609, 1766.311f, 1288.508f, 394.349f, (byte) 94, 5000);
                break;
			case 217609:
				despawnNpc(npc);
    ...
    public void doReward(Player player) {
        ...
        player.sendPck(new SM_INSTANCE_SCORE(instanceReward, InstanceScoreType.END_PROGRESS));
    }
        ...
        instance.doOnAllPlayers(new Visitor<Player>() {
            ...
            public void visit(Player p) {
                if (player.getObjectId() == p.getObjectId()) {
                    p.sendPck(new SM_SYSTEM_MESSAGE(1400932));
                } else {
                    p.sendPck(new SM_SYSTEM_MESSAGE(1400933, player.getName()));
                }
            }
        ...
        switch (type) {
            ...
            case START_STAGE_7_ROUND_1:
                ...
                if (player != null) {
                    ...
                    sp(npcId, 1784.848f, 806.7728f, 469.82202f, (byte) 0, 6000);
                }
                break;
            ...
            case START_STAGE_10_ROUND_1:
                ...
                sp(217601, 1774.4563f, 1302.1516f, 394.3f, (byte) 82, 3000);
                sp(217602, 1765.1488f, 1305.1216f, 394.3f, (byte) 84, 3000);
				sp(217603, 1756.213f, 1268.0781f, 394.3f, (byte) 112, 10000);
                sp(217604, 1748.4563f, 1276.1516f, 394.3f, (byte) 112, 10000);
                sp(217605, 1745.1488f, 1291.1216f, 394.3f, (byte) 112, 10000);
				sp(217606, 1751.1488f, 1303.1216f, 394.3f, (byte) 112, 10000);
                break;
            case START_STAGE_5:
                stage = 5;
    ...
    private void startStage1Round5() {
		...
		if (player != null) {
			...
			sp(npcId, 332.093f, 349.36847f, 96.090935f, (byte) 0, 8000);
		}
    }
    ...
    private Npc sp(int npcId, float x, float y, float z, int h) {
        Npc npc = null;
        if (!isInstanceDestroyed) {
