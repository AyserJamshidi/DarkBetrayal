 ...
 * Romanz
 */
@AIName("legion_invite_ely")//730003
public class LegionInviteElyAI2 extends ActionItemNpcAI2 {
    ...
    public void handleUseItemFinish(Player player) {
        RequestResponseHandler responseHandler = new RequestResponseHandler(player) {
            ...
            public void acceptRequest(Creature requester, Player responder) {
                ...
                Legion legion = service.getLegion("ElyBeginner");//legion ely name
        ...
        if (requested) {
            PacketSendUtility.sendPck(player, new SM_QUESTION_WINDOW(902247, 0, 0, "Желаете вступить в легион для новичков " + "ElyBeginner" + "?"));//legion ely name
        }
    }
}