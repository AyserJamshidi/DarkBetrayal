...
public final class SummonsService {
    ...
    public static void release(Summon summon, UnsummonType unsummonType, boolean isAttacked) {
        ...
        switch (unsummonType) {
            case UNSPECIFIED:
                master.sendPck(SM_SYSTEM_MESSAGE.STR_SKILL_SUMMON_UNSUMMON_FOLLOWER(summon.getNameId()));
                master.sendPck(new SM_SUMMON_UPDATE(summon));
                break;
            case DISTANCE:
                master.sendPck(SM_SYSTEM_MESSAGE.STR_SKILL_SUMMON_UNSUMMON_BY_TOO_DISTANCE);
                master.sendPck(new SM_SUMMON_UPDATE(summon));
                break;
        }
