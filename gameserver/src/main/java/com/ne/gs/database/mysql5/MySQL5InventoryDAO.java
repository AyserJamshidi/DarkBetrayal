...
public class MySQL5InventoryDAO extends InventoryDAO {
    ...
    private Item constructItem(final int storage, ResultSet rset) throws SQLException {
        ...
        /*if (item == null) {
            System.out.println("Found null thingy:");
            System.out.println("uniId: " + itemUniqueId + ", itemId: " + itemId + ", itemCount: " + itemCount + ", itemColor: " + itemColor + ", colorExpireTime: " +
                    colorExpireTime + ", itemCreator: " + itemCreator + ", expireTime: " + expireTime + ", activationCount: " + activationCount + ", isEquiped: " +
                    (isEquiped == 1) + ", isSoulBound: " + (isSoulBound == 1) + ", slot: " + slot + ", storage: " + storage + ", enchant: " + enchant + ", itemSkin: " + itemSkin +
                    ", fusionedItem: " + fusionedItem + ", optionalSocket: " + optionalSocket + ", optionalFusionSocket: " + optionalFusionSocket + ", charge: " + charge + ", randomBonus: " + randomBonus);
        }*/
        return item;
    }
