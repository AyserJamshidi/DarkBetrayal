...
public final class CustomConfig {
     ...
     */
    @Property(key = "gameserver.protection.time", defaultValue = "20")
    public static int SPAWN_PROTECTION_TIME;
    ...
    @Property(key = "gameserver.faction.level", defaultValue = "9")
    public static int FACTION_LEVEL;

    /**
     * .world cfg
     */
    @Property(key = "gameserver.world.cmdchannel", defaultValue = "true")
    public static boolean WORLD_CMD_CHANNEL;

    @Property(key = "gameserver.world.use.cost", defaultValue = "5")
    public static int WORLD_CHAT_USE_COST;
    /**
    ...
    /**
     * Enable or disable use kisk in SILENTERA CANYON - 600010000
     */
    @Property(key = "gameserver.item.toypetspawn.enable.in.silentera.canyon", defaultValue = "false")
    public static boolean TOYPETSPAWN_SILENTERA_CANYON_ENABLE;
    /**
     * Enable or disable use kisk in TIAMARANTA EYE - 600040000
     */
    @Property(key = "gameserver.item.toypetspawn.enable.in.tiamaranta.eye", defaultValue = "false")
    public static boolean TOYPETSPAWN_TIAMARANTA_EYE_ENABLE;
     ...
     * .dye cfg
     */
    @Property(key = "gameserver.dye.cmdchannel", defaultValue = "true")
    public static boolean DYE_REPAINT;

    @Property(key = "gameserver.dye.use.cost", defaultValue = "5")
    public static int DYE_REPAINT_COST;
    ...
    @Property(key = "gameserver.reskin.cost", defaultValue = "30")
    public static int RESKIN_COST;
	
	@Property(key = "gameserver.reskin.cost1", defaultValue = "30")
    public static int RESKIN_COST1;
