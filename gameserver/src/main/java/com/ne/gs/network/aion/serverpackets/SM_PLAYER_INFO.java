...
public class SM_PLAYER_INFO extends AionServerPacket {
    ...
    protected void writeImpl(AionConnection con) {
        ...
        String name = player.getImplementator().result(FFALoc.VisiblePlayerName.class, Tuple.of(player, activePlayer));
        writeS(name);
        ...
        if (player.getConditioner().check(FFALoc.IsLegionVisible.class, player)) {
