...
public class SM_QUESTION_WINDOW extends AionServerPacket {
     ...
     * &lt;font font_xml="v3_msgbox_money"&gt;%qina0&lt;/font&gt;.&lt;/p&gt;&lt;p&gt;Do you want to heal your
     * soul?&lt;/p&gt;
     */
    ...
    /**
     * To upgrade the %0 skill, you need &lt;font font_xml="v3_msgbox_money"&gt;%qina1&lt;/font&gt;. Are you sure you
     * want to upgrade the skill?
     */
    public static final int STR_CRAFT_ADDSKILL_CONFIRM = 900852;

    /**
     * &lt;p align="left"&gt;%0 is about to summon you using %1. Will you accept?&lt;/p&gt; &lt;p&gt;&lt;/p&gt;&lt;p
     * align="left"&gt;You must decide in %2 seconds.&lt;/p&gt;
     */
    ...
    /**
     * &lt;p&gt;%0 legion has invited your force to join their League.&lt;/p&gt;&lt;p&gt;Will you accept the
     * invitation?&lt;/p&gt;
     */
    public static final int STR_MSGBOX_UNION_INVITE_ME = 902249;

    /**
     * &lt;p&gt;The %0 must be soulbound to equip it.&lt;/p&gt; &lt;p&gt;You cannot trade the item that has been
     * soulbound.&lt;/p&gt; &lt;p&gt;Equip?&lt;/p&gt;
     */
     ...
     * font_xml="v3_msgbox_money"&gt;%qina2&lt;/font&gt;to do this. &lt;/p&gt;&lt;p&gt;Are you sure you want to
     * condition them?&lt;/p&gt;
     */
    ...
    /**
     * Empty dialog, takes whatever string you give it.
     */
    public static final int STR_EMPTY_FIELD = 901756;
    ...
    protected void writeImpl(AionConnection con) {
        ...
        switch (code) {
            case STR_ASK_DOOR_REPAIR_POPUPDIALOG: {
                writeD(0x00);
                writeD(0x00);
                writeD(0x00);
                writeH(0x00);
            ...
            case STR_BUDDYLIST_ADD_BUDDY_REQUEST: {
                writeB(new byte[17]);
                break;
            }
            case STR_INSTANCE_DUNGEON_WITH_DIFFICULTY_ENTER_CONFIRM: {
                writeD(0x00);
                writeH(0x00);
                writeC(0x01);
                writeD(senderId);
