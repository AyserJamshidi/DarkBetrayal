...
public class SM_SYSTEM_MESSAGE extends AionServerPacket {
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_BoostHate_ME_TO_B(String skillcaster, String value0d, String skilltarget,
     ...
     * [%SkillCaster] %0d [%SkillTarget]'s enmity %0 by using [%SkillName].
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_HostileUp_ME_TO_B(String skillcaster, String value0d, String skilltarget,
                                                                     String value0, String skillname) {
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_StatDown_ME_TO_B(String skillcaster, String skilltarget, String value0,
                                                                    String skillname) {
     ...
     * [%SkillCaster] has weakened [%SkillTarget]'s %0 by using [%SkillName].
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_StatDown_A_TO_ME(String skillcaster, String skilltarget, String value0,
                                                                    String skillname) {
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_StatDown_A_TO_SELF(String skilltarget, String value0, String skillcaster,
                                                                      String skillname) {
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_StatUp_A_TO_SELF(String skilltarget, String value0, String skillcaster,
                                                                    String skillname) {
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_CaseHeal_INTERVAL_A_TO_B(String skilltarget, int num0, String skillcaster,
                                                                            String skillname) {
     ...
     * [%SkillTarget]'s flight time has decreased by %num0 because [%SkillCaster] used [%SkillName].
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_FPATK_INTERVAL_A_TO_B(String skilltarget, int num0, String skillcaster,
                                                                         String skillname) {
     ...
     * [%SkillTarget]'s flight time has decreased by %num0 because [%SkillCaster] used [%SkillName].
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_FPATK_Instant_A_TO_B(String skilltarget, int num0, String skillcaster,
                                                                        String skillname) {
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_FPHeal_INTERVAL_A_TO_B(String skilltarget, int num0, String skillcaster,
                                                                          String skillname) {
     ...
     * [%SkillTarget] recovered %num0 HP because [%SkillCaster] used [%SkillName].
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_Heal_INTERVAL_A_TO_B(String skilltarget, int num0, String skillcaster,
                                                                        String skillname) {
     ...
     * [%SkillTarget] recovered %num0 HP because [%SkillCaster] used [%SkillName].
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_Heal_Instant_HEAL_A_TO_B(String skilltarget, int num0, String skillcaster,
                                                                            String skillname) {
     ...
     * [%SkillCaster] inflicted %num0 damage on [%SkillTarget] by using [%SkillName].
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_MoveBehindATK_A_TO_B(String skillcaster, int num0, String skilltarget,
                                                                        String skillname) {
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_MPAttack_Instant_A_TO_B(String skilltarget, int num0, String skillcaster,
                                                                           String skillname) {
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_MPHeal_INTERVAL_A_TO_B(String skilltarget, int num0, String skillcaster,
                                                                          String skillname) {
     ...
     * [%SkillTarget] has transformed into %0 because [%SkillCaster] used [%SkillName].
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_Polymorph_A_TO_B(String skilltarget, String value0, String skillcaster,
                                                                    String skillname) {
     ...
     * [%SkillCaster] inflicted %num0 damage on [%SkillTarget] by using [%SkillName].
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_ProcATK_Instant_A_TO_B(String skillcaster, int num0, String skilltarget,
                                                                          String skillname) {
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_Protect_INTERVAL_A_TO_B(String skilltarget, int num0, String skillcaster,
                                                                           String skillname) {
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_Reflector_INTERVAL_A_TO_B(String skilltarget, int num0, String skillcaster,
                                                                             String skillname) {
     ...
     * [%SkillTarget] has transformed into %0 because [%SkillCaster] used [%SkillName].
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_ShapeChange_A_TO_B(String skilltarget, String value0, String skillcaster,
                                                                      String skillname) {
     ...
     * [%SkillTarget] blocked %num0 damage because [%SkillCaster] used [%SkillName].
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_Shield_INTERVAL_A_TO_B(String skilltarget, int num0, String skillcaster,
                                                                          String skillname) {
     ...
     * [%SkillCaster] inflicted %num0 damage on [%SkillTarget] by using [%SkillName].
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_SkillATK_Instant_A_TO_B(String skillcaster, int num0, String skilltarget,
                                                                           String skillname) {
     ...
     * [%SkillCaster] inflicted %num0 damage on [%SkillTarget] by using [%SkillName].
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_SpellATK_Instant_A_TO_B(String skillcaster, int num0, String skilltarget,
                                                                           String skillname) {
     ...
     * [%SkillTarget] is in the weaken %0 state because [%SkillCaster] used [%SkillName].
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_StatDown_A_TO_B(String skilltarget, String value0, String skillcaster,
                                                                   String skillname) {
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_SummonHoming_A_TO_B(String skillcaster, String value0, String skilltarget,
                                                                       String skillname) {
     ...
     * [%SkillCaster] has summoned %0 to attack [%SkillTarget] by using [%SkillName].
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_SummonServant_A_TO_B(String skillcaster, String value0, String skilltarget,
                                                                        String skillname) {
     ...
     * [%SkillCaster] has summoned %0 to [%SkillTarget] by using [%SkillName].
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_SummonTotem_A_TO_B(String skillcaster, String value0, String skilltarget,
                                                                      String skillname) {
     ...
     * [%SkillCaster] has summoned %0 to [%SkillTarget] by using [%SkillName].
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_SummonTrap_A_TO_B(String skillcaster, String value0, String skilltarget,
                                                                     String skillname) {
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_SUCC_WeaponStatUp_A_TO_B(String skillcaster, String skilltarget, String value0,
                                                                       String skillname) {
    ...
    public static SM_SYSTEM_MESSAGE STR_QUEST_GET_REWARD_TITLE(int value0) {
        return new SM_SYSTEM_MESSAGE(1300035, DescId.of(value0));
    }
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_MSG_CANNOT_USE_ITEM_DURING_PATH_FLYING(DescId descId) {
        return new SM_SYSTEM_MESSAGE(1300048, descId);
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_CANNOT_USE_ITEM_INVALID_RANK(int i) {
        return new SM_SYSTEM_MESSAGE(1300370, DescId.of(i));
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_CANNOT_USE_ITEM_TOO_LOW_LEVEL_MUST_BE_THIS_LEVEL(int value1, int value0) {
        return new SM_SYSTEM_MESSAGE(1300372, value0, DescId.of(value1));
    }
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_UNBREAKABLE_ITEM(DescId value0) {
     ...
     * You cannot use %0.
     */
    public static SM_SYSTEM_MESSAGE STR_CANT_USE_ITEM(DescId value0) {
    ...
    public static SM_SYSTEM_MESSAGE STR_CAN_NOT_GET_LORE_ITEM(DescId value0value) {
        return new SM_SYSTEM_MESSAGE(1300422, value0value);
    }
     ...
     * You have used %0.
     */
    public static SM_SYSTEM_MESSAGE STR_USE_ITEM(DescId value0) {
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_ITEM_CANCELED(DescId id) {
    ...
    public static SM_SYSTEM_MESSAGE STR_DECOMPOSE_ITEM_FAILED(int value0) {
        return new SM_SYSTEM_MESSAGE(1300448, DescId.of(value0));
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_DECOMPOSE_ITEM_SUCCEED(int value0) {
        return new SM_SYSTEM_MESSAGE(1300449, DescId.of(value0));
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_DECOMPOSE_ITEM_CANCELED(int nameId) {
        return new SM_SYSTEM_MESSAGE(1300450, DescId.of(nameId));
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_DECOMPOSE_ITEM_INVALID_STANCE(int value0) {
        return new SM_SYSTEM_MESSAGE(1300451, DescId.of(value0));
    }
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_ENCHANT_ITEM_SUCCEED(DescId descId) {
        return new SM_SYSTEM_MESSAGE(1300455, descId);
    }

    /**
     * You have failed to enchant %0.
     */
    public static SM_SYSTEM_MESSAGE STR_ENCHANT_ITEM_FAILED(DescId descId) {
        return new SM_SYSTEM_MESSAGE(1300456, descId);
    }
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_GIVE_ITEM_OPTION_SUCCEED(DescId descId) {
        return new SM_SYSTEM_MESSAGE(1300462, descId);
    }

    /**
     * You have failed in the manastone socketing of %0.
     */
    public static SM_SYSTEM_MESSAGE STR_GIVE_ITEM_OPTION_FAILED(DescId descId) {
        return new SM_SYSTEM_MESSAGE(1300463, descId);
    }
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_CHANGE_ITEM_SKIN_NOT_COMPATIBLE(DescId descId, DescId descId2) {
        return new SM_SYSTEM_MESSAGE(1300480, descId, descId2);
    }

    /**
     * You do not have enough Kinah to modify the appearance of %0.
     */
    public static SM_SYSTEM_MESSAGE STR_CHANGE_ITEM_SKIN_NOT_ENOUGH_GOLD(DescId descId) {
        return new SM_SYSTEM_MESSAGE(1300481, descId);
    }
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_CHANGE_ITEM_SKIN_SUCCEED(DescId descId) {
        return new SM_SYSTEM_MESSAGE(1300483, descId);
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_SOUL_BOUND_ITEM_SUCCEED(int value0) {
        return new SM_SYSTEM_MESSAGE(1300485, DescId.of(value0));
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_SOUL_BOUND_ITEM_CANCELED(int value0) {
        return new SM_SYSTEM_MESSAGE(1300487, DescId.of(value0));
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_SOUL_BOUND_INVALID_STANCE(int value0) {
        return new SM_SYSTEM_MESSAGE(1300489, DescId.of(value0));
    }
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_GIVE_ITEM_PROC_ENCHANTED_TARGET_ITEM(DescId descId) {
        return new SM_SYSTEM_MESSAGE(1300508, descId);
    }
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_ITEM_COLOR_REMOVE_SUCCEED(int value0) {
        return new SM_SYSTEM_MESSAGE(1300510, DescId.of(value0));
    }

    /**
     * You have dyed %0 %1.
     */
    public static SM_SYSTEM_MESSAGE STR_ITEM_COLOR_CHANGE_SUCCEED(int value0, int value1) {
        return new SM_SYSTEM_MESSAGE(1300511, DescId.of(value0), DescId.of(value1));
    }

    /**
     * %0 cannot be dyed.
     */
    public static SM_SYSTEM_MESSAGE STR_ITEM_COLOR_CHANGE_ERROR_CANNOTDYE(int value0) {
        return new SM_SYSTEM_MESSAGE(1300512, DescId.of(value0));
    }
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_QUEST_ACQUIRE_ERROR_EQUIP_ITEM(DescId descId) {
        return new SM_SYSTEM_MESSAGE(1300593, descId);
    }

    /**
     * You can only receive this quest when you have %0 in your inventory.
     */
    public static SM_SYSTEM_MESSAGE STR_QUEST_ACQUIRE_ERROR_INVENTORY_ITEM(DescId descId) {
        return new SM_SYSTEM_MESSAGE(1300594, descId);
    }
    ...
    /**
     * /CreateChannel [ChannelName] [OptionalPassword]: Creates a private channel. /JoinChannel [ChannelName] [Password]: Enters an existing private channel.
     * Password required if one was set. /LeaveChannel [ChannelNumber]: Leaves a private channel. /ChannelMemberInfo [ChannelNumber]: Shows who's in a channel.
     * /ChannelInfo [ChannelNumber]: Shows information for a channel you are in. /ChannelBanInfo [ChannelNumber]: Shows who is banned from a channel.
     * /BanFromChannel [ChannelNumber] [CharacterName]: The channel owner can permanently remove a character from the channel. /UnbanFromChannel [ChannelNumber]
     * [CharacterName]: The channel owner can reinstate a banned character's access to a channel. /ChangeChannelLeader [ChannelNumber] [CharacterName]: The
     * channel owner makes another character the channel owner. /ChangeChannelPassword [ChannelNumber] [Password]: The channel owner can change the password.
     ...
     * submitted %3 petitions today, and there are %4 more petitions left. Thank you!
     */
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_ARTIFACT_CASTING(DescId race, String value1, DescId descId) {
        return new SM_SYSTEM_MESSAGE(1301033, race, value1, descId);
    }

    /**
     * The %1 Artifact core in %0 possession has been deactivated.
     */
    public static SM_SYSTEM_MESSAGE STR_ARTIFACT_CORE_CASTING(DescId race, DescId descId) {
        return new SM_SYSTEM_MESSAGE(1301034, race, descId);
    }

    /**
     * The activation of the %1 Artifact in %0 possession has been cancelled.
     */
    public static SM_SYSTEM_MESSAGE STR_ARTIFACT_CANCELED(DescId race, DescId descId) {
        return new SM_SYSTEM_MESSAGE(1301035, race, descId);
    }

    /**
     * The %0 %1 has succeeded in activating the %2 Artifact.
     */
    public static SM_SYSTEM_MESSAGE STR_ARTIFACT_FIRE(DescId race, String value1, DescId descId) {
        return new SM_SYSTEM_MESSAGE(1301036, race, value1, descId);
    }
     ...
     * %0 is now vulnerable.
     */
    public static SM_SYSTEM_MESSAGE STR_ABYSS_PVP_ON(DescId descId) {
        return new SM_SYSTEM_MESSAGE(1301040, descId);
    }

    /**
     * %0 is no longer vulnerable.
     */
    public static SM_SYSTEM_MESSAGE STR_ABYSS_PVP_OFF(DescId descId) {
        return new SM_SYSTEM_MESSAGE(1301041, descId);
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_SKILL_PROC_EFFECT_OCCURRED(int value0) {
        return new SM_SYSTEM_MESSAGE(1301062, DescId.of(value0));
    }
    ...
    /**
     * Failed to create the character due to a World GDB error.
     */
    ...
    /**
     * Either the usage period has expired or we are experiencing a temporary connection difficulty. For more information, please contact the administrators or
     * our customer center.
     */
    ...
    public static SM_SYSTEM_MESSAGE STR_CRAFT_RECIPE_CANT_LEARN_SKILL(int i) {
        return new SM_SYSTEM_MESSAGE(1330062, DescId.of(i));
    }
     ...
     * You have gathered %0.
     */
    public static SM_SYSTEM_MESSAGE STR_EXTRACT_GATHER_SUCCESS_1_BASIC(DescId descId) {
        return new SM_SYSTEM_MESSAGE(1330078, descId);
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_GET_EXP_DESC(DescId value0, long num1) {
        return new SM_SYSTEM_MESSAGE(1370000, value0, num1);
    }
     ...
     * %0 has acquired %1.
     */
    public static SM_SYSTEM_MESSAGE STR_MSG_GET_ITEM_PARTYNOTICE(String value0, DescId descId) {
        return new SM_SYSTEM_MESSAGE(1390002, value0, descId);
    }
    ...
    /**
     * You are Exhausted, and the XP or item rewards gained are reduced to 0%. Please log out and take a break for your health. It will be returned to normal
     * when the accumulated logout time reaches 5 hours.
     */
     ...
     * %1 of %0 uses %3 in %2.
     */
    public static SM_SYSTEM_MESSAGE STR_SKILL_ABYSS_SKILL_IS_FIRED(Player player, DescId skill) {
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_MSG_LOOT_GET_ITEM_ME(DescId descId) {
        return new SM_SYSTEM_MESSAGE(1390180, descId);
    }

    /**
     * %0 is now the owner of %1.
     */
    public static SM_SYSTEM_MESSAGE STR_MSG_LOOT_GET_ITEM_OTHER(String value0, DescId descId) {
        return new SM_SYSTEM_MESSAGE(1390181, value0, descId);
    }
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_MSG_LOOT_ALREADY_DISTRIBUTING_ITEM(DescId descId) {
        return new SM_SYSTEM_MESSAGE(1390219, descId);
    }
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_MSG_DONT_GET_PRODUCTION_EXP(DescId descId) {
        return new SM_SYSTEM_MESSAGE(1390221, descId);
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_MSG_GET_CASH_TITLE(int value0) {
        return new SM_SYSTEM_MESSAGE(1390242, DescId.of(value0));
    }
     ...
     * %0 %1 %2 has died in %3.
     */
    public static SM_SYSTEM_MESSAGE STR_ABYSS_ORDER_RANKER_DIE(Player victim, DescId rankDescId) {
    ...
    /**
     * %WORLDNAME0% region restricts access. You cannot reenter the region for %1 hour(s) if all your group members left the region or if you left the current
     * group.
     */
    ...
    /**
     * %WORLDNAME0% region restricts access. You cannot reenter the region for %1 minute(s) if all your group members left the region or if you left the current
     * group.
     */
    ...
    /**
     * You entered into the Phase %num0 Restriction state because the auto hunting reports have accumulated. You can check the Restriction Phase and the Release
    ...
    /**
     * You are currently in Phase 2 Restriction State, and will be downgraded to Phase 1 in %0 minutes. You now receive less XP, Kinah and Abyss Points, and the
     * chance of successful gathering and extraction has been decreased. You will face greater restrictions if reports continue to accumulate.
     */
    ...
    /**
     * You are currently in Phase 3 Restriction State and will be downgraded to Phase 2 in %0 minutes. You cannot acquire any loot, and you now receive less XP,
     * Kinah and Abyss Points, and the chance of successful gathering and extraction has been significantly decreased. You are banned from joining a Group or
     * Alliance. You will face greater restrictions if reports continue to accumulate.
     */
    ...
    /**
     * You are currently at Phase 4 Restriction State and will be downgraded to Phase 3 in %0 minutes. You cannot acquire any loot, XP, Kinah, or Abyss Points,
     * and are unable to gather or extract any items. You are also banned from joining a Group or Alliance.
     */
    ...
    public static SM_SYSTEM_MESSAGE STR_COMPOUND_ERROR_NOT_AVAILABLE(int i) {
        return new SM_SYSTEM_MESSAGE(1400289, DescId.of(i));
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_COMPOUNDED_ITEM_DECOMPOUND_SUCCESS(int i) {
        return new SM_SYSTEM_MESSAGE(1400335, DescId.of(i));
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_COMPOUND_SUCCESS(int i, int j) {
        return new SM_SYSTEM_MESSAGE(1400336, DescId.of(i), DescId.of(j));
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_COMPOUND_ERROR_NOT_ENOUGH_MONEY(int i, int j) {
        return new SM_SYSTEM_MESSAGE(1400337, DescId.of(i), DescId.of(j));
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_GET_EXP_VITAL_BONUS_DESC(DescId value0, long num1, long num2) {
        return new SM_SYSTEM_MESSAGE(1400342, value0, num1, num2);
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_GET_EXP_MAKEUP_BONUS_DESC(DescId value0, long num1, long num2) {
        return new SM_SYSTEM_MESSAGE(1400343, value0, num1, num2);
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_GET_EXP_VITAL_MAKEUP_BONUS_DESC(DescId value0, long num1, long num2, long num3) {
        return new SM_SYSTEM_MESSAGE(1400344, value0, num1, num2, num3);
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_DECOMPOUND_ERROR_NOT_AVAILABLE(int i) {
        return new SM_SYSTEM_MESSAGE(1400373, DescId.of(i));
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_MSG_ENCHANT_ITEM_SUCCEEDED_15(String playerName, int nameId) {
        return new SM_SYSTEM_MESSAGE(1400435, playerName, DescId.of(nameId));
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_MSG_END_OF_EXCHANGE_TIME(int nameId, int timeMin) {
        return new SM_SYSTEM_MESSAGE(1400553, DescId.of(nameId), timeMin);
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_MSG_EXCHANGE_TIME_OVER(int value0) {
        return new SM_SYSTEM_MESSAGE(1400555, DescId.of(value0));
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_MSG_TOYPET_FEED_FOOD_NOT_LOVEFLAVOR(String petName, int nameId) {
        return new SM_SYSTEM_MESSAGE(1400618, petName, DescId.of(nameId));
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_FACTION_LEAVE_BY_LEVEL_LIMIT(int value0) {
        return new SM_SYSTEM_MESSAGE(1400770, DescId.of(value0));
    }
     ...
     */
    public static SM_SYSTEM_MESSAGE STR_MSG_ITEM_CHARGE_SUCCESS(DescId descId, int level) {
        return new SM_SYSTEM_MESSAGE(1400887, descId, level);
    }

    public static SM_SYSTEM_MESSAGE STR_MSG_ITEM_CHARGE2_SUCCESS(DescId descId, int level) {
        return new SM_SYSTEM_MESSAGE(1401335, descId, level);
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_MSG_UNEQUIP_RANKITEM_TIMER_10M(int value0) {
        return new SM_SYSTEM_MESSAGE(1401327, DescId.of(value0));
    }

    public static SM_SYSTEM_MESSAGE STR_MSG_UNEQUIP_RANKITEM_TIMER_1M(int value0) {
        return new SM_SYSTEM_MESSAGE(1401328, DescId.of(value0));
    }

    public static SM_SYSTEM_MESSAGE STR_MSG_UNEQUIP_RANKITEM(int value0) {
        return new SM_SYSTEM_MESSAGE(1401329, DescId.of(value0));
    }

    public static SM_SYSTEM_MESSAGE STR_MSG_CANT_USE_HOUSE_OBJECT_ITEM_EQUIP(DescId id) {
        return new SM_SYSTEM_MESSAGE(1401294, id);
    }

    public static SM_SYSTEM_MESSAGE STR_MSG_CANT_USE_HOUSE_OBJECT_ITEM_CHECK(DescId id) {
    ...
    public static SM_SYSTEM_MESSAGE STR_MSG_CANNOT_USE_ALREADY_HAVE_REWARD_ITEM(int rewardNameId, int objectNameId) {
        return new SM_SYSTEM_MESSAGE(1401396, DescId.of(rewardNameId), calculateNameId(objectNameId));
    }
    ...
    public static SM_SYSTEM_MESSAGE STR_MSG_HOUSING_OBJECT_REWARD_ITEM(int objectNameId, int rewardItemNameId) {
        return new SM_SYSTEM_MESSAGE(1401263, calculateNameId(objectNameId), DescId.of(rewardItemNameId));
    }
    ...
    protected void writeImpl(AionConnection con) {
        ...
        for (Object param : params) {
            if (param instanceof DescId) {
                writeH(0x24);
                writeD(((DescId) param).getValue());
                writeH(0x00); // unk
            } else {
