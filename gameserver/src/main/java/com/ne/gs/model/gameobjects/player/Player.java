...
public class Player extends Creature {
    ...
    public boolean isEnemyFrom(Player player) {
        if (player.getObjectId().equals(getObjectId())) {
            return false;
        }

        return player.getConditioner().check(IsEnemyCond.class, Tuple.of(this, player));
    }
    ...
    public boolean isDueling(Player player) {
        Integer opponentUid = getStateEnv(CreatureState.DUELING);
        return opponentUid != null && player.getObjectId().equals(opponentUid);
    }
